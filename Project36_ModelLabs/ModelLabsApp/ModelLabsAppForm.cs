...
namespace ModelLabsApp
{
	public partial class ModelLabsAppForm : Form
	{
		...
		private void InitGUIElements()
		{
			...
			comboBoxProfile.SelectedItem = SupportedProfiles.Project36;
		...
		private void ShowOpenCIMXMLFileDialog()
		{
            ...
            openFileDialog.InitialDirectory = Path.GetFullPath(@"..\Resources");
		...
		private void ConvertCIMXMLToDMSNetworkModelDelta()
		{
			...
			try
			{
				...
				if (nmsDelta != null)
				{
					...
					using (XmlTextWriter xmlWriter = new XmlTextWriter(@"..\Output\DeltaExport.xml", Encoding.UTF8))
					{
